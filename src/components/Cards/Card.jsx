    ...
    return (
        <>
            <div className={"card" + css.cardtam} style={{width:'100%'}}>
                ...
                <div style={{justifyContent: "space-between "}} className={"card-body d-flex align-items-space-between " + (css.gap130) + (css.espacomenor)}>
                ...
                <div className={"d-flex pt-5 " + (css.gap28 ) + " " + (css.espacogrande)}>
